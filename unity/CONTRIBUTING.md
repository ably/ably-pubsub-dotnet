...
- This script is responsible for merging all dependencies into `Ably.PubSub.Device.dll` (the core plus the device door and dependencies, merged) and copying it to `unity/Assets/Ably/Plugins/`.
