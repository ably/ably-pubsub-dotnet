...
namespace IO.Ably.Tests
{
    public class HttpProtocolTests
    {
        ...
        {
            var rest = new PubSubHttpClient(new ClientOptions());
        ...
        {
            var rest = new PubSubHttpClient(new ClientOptions() { UseBinaryProtocol = true});
        ...
        public void WhenProtocolIsNotDefined_AndMsgPackDisabled_DefaultsToJson()
        {
            ...
            var rest = new PubSubHttpClient(new ClientOptions { Key = "best.test:key" });
        ...
        {
            var rest = new PubSubHttpClient(new ClientOptions { UseBinaryProtocol = true, Key = "best.test:key" });
            rest.Protocol.Should().Be(Protocol.Json);
        }
#endif
        ...
        {
            var rest = new PubSubHttpClient(new ClientOptions { UseBinaryProtocol = false, Key = "best.test:key" });
            rest.Protocol.Should().Be(Protocol.Json);
        }
