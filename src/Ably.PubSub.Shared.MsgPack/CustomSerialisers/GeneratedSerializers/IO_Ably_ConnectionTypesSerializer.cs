...
#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member
    public class IO_Ably_ConnectionTypesSerializer : MsgPack.Serialization.MessagePackSerializer<Ably.PubSub.ConnectionTypes> {
        
        private MsgPack.Serialization.MessagePackSerializer<string> _serializer0;
        
        private MsgPack.Serialization.MessagePackSerializer<Ably.PubSub.ResourceCount> _serializer1;
        ...
        public IO_Ably_ConnectionTypesSerializer(MsgPack.Serialization.SerializationContext context) : 
            ...
            schema1 = null;
            this._serializer1 = context.GetSerializer<Ably.PubSub.ResourceCount>(schema1);
        }
        
        protected override void PackToCore(MsgPack.Packer packer, Ably.PubSub.ConnectionTypes objectTree) {
        ...
        protected override Ably.PubSub.ConnectionTypes UnpackFromCore(MsgPack.Unpacker unpacker)
        {
            Ably.PubSub.ConnectionTypes result = default(Ably.PubSub.ConnectionTypes);
            result = new Ably.PubSub.ConnectionTypes();
            ...
            for (int i = 0; (i < itemsCount0); i = (i + 1))
            {
                ...
                nullable2 = MsgPack.Serialization.UnpackHelpers.UnpackStringValue(unpacker,
                    typeof(Ably.PubSub.ConnectionTypes), "MemberName");
                if (((nullable2 == null)
                     == false))
                {
                    key = nullable2;
                ...
                if ((key == "tls"))
                {
                    Ably.PubSub.ResourceCount nullable5 = default(Ably.PubSub.ResourceCount);
                ...
                else
                {
                    if ((key == "plain"))
                    {
                        Ably.PubSub.ResourceCount nullable4 = default(Ably.PubSub.ResourceCount);
                        if ((unpacker.Read() == false))
                        {
                            throw MsgPack.Serialization.SerializationExceptions.NewMissingItem(i);
                        }
                    ...
                    else
                    {
                        if ((key == "all"))
                        {
                            Ably.PubSub.ResourceCount nullable3 = default(Ably.PubSub.ResourceCount);
                            if ((unpacker.Read() == false))
                            {
                                throw MsgPack.Serialization.SerializationExceptions.NewMissingItem(i);
                            }
